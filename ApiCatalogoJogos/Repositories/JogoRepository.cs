...
namespace ApiCatalogoJogos.Repositories
{
    ...
    {
        private static Dictionary<Guid, Jogo>
            jogos =
                new Dictionary<Guid, Jogo>()
                {
                    {
                        ...
                        new Jogo {
                            Id =
                                Guid
                                    .Parse("0ca314a5-9282-45d8-92c3-2985f2a9fd04"),
                            Nome = "Fifa 21",
                            Produtora = "EA",
                            Preco = 200
                        }
                    },
                    {
                        ...
                        new Jogo {
                            Id =
                                Guid
                                    .Parse("eb909ced-1862-4789-8641-1bba36c23db3"),
                            Nome = "Fifa 20",
                            Produtora = "EA",
                            Preco = 190
                        }
                    },
                    {
                        ...
                        new Jogo {
                            Id =
                                Guid
                                    .Parse("5e99c84a-108b-4dfa-ab7e-d8c55957a7ec"),
                            Nome = "Fifa 19",
                            Produtora = "EA",
                            Preco = 180
                        }
                    },
                    {
                        ...
                        new Jogo {
                            Id =
                                Guid
                                    .Parse("da033439-f352-4539-879f-515759312d53"),
                            Nome = "Fifa 18",
                            Produtora = "EA",
                            Preco = 170
                        }
                    },
                    {
                        ...
                        new Jogo {
                            Id =
                                Guid
                                    .Parse("92576bd2-388e-4f5d-96c1-8bfda6c5a268"),
                    ...
                    },
                    {
                        ...
                        new Jogo {
                            Id =
                                Guid
                                    .Parse("c3c9b5da-6a45-4de1-b28b-491cbf83b589"),
